...
Breast_SEER_Class6 <- read_delim("T:/Teaching/Courses/Advanced_Data_Analysis/Advanced-Data-Analysis-master/Class 6 GLM Oridnal and Multinomial/Breast_SEER_Class6.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
- Examples
- *Continous variable*
- The odds of being diagnosed at stage I is 0.973 times the odss of being diagnosed at stages II to IV with each one-year increase in age, holding other variables constant. 
- *OR*
- The odds of being diagnosed at stage I or II  is 0.973 times the odds of being diagnosed at stages III to IV with each one-year increase in age, holding all other variables constant. 
- *Categorical variable*
- The odds of being diagnosed at stage I are 0.450 times the odds of being diagnosed at combined outcomes stage II to IV for patients with private insurance than those without insurance at diagnosis, holding all other variables constant.
- *OR*
- The odds of being diagnosed at stage I and II are 0.450 times the odds of being diagnosed at stages III to IV for patients with private insurance than those without insurance at diagnosis, holding other variables constant. 
